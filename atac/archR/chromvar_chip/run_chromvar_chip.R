...
# args$motifmatcher <- file.path(io$basedir,sprintf("results/rna_atac/virtual_chipseq/metacells/%s/motifmatchr_virtual_chip.rds",args$motif_annotation))
...
# args$outdir <- file.path(io$basedir,"results/atac/archR/chromvar_chip/metacells")
