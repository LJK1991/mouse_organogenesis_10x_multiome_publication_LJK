here::i_am("atac/archR/differential/cells/celltype/parse_differential_results.R")
...
# args <- list()
# args$diff_results_dir <- file.path(io$basedir,"results/atac/archR/differential/cells/celltype/PeakMatrix")
# args$min_cells <- 5
# args$outdir <- file.path(io$basedir,"results/atac/archR/differential/cells/celltype/PeakMatrix/parsed")
## END TEST ##
